...
늘 중점적으로 고민하는 부분은 **사용하기 편하고 간결하게 동작하는 코드**를 만들고자 하는 것입니다!👩‍💻

아직 배워나가는 단계이기 때문에 개발 속도도 중요하지만 학교나 인터넷에서 그간 배워온 지식을 적용할 수 있는 기능이나 구조를 만드려고 하는 편입니다. Fins에서도 학습했던 오브젝트풀링이나 커스텀 인스펙터, A*라는 알고리즘을 사용하고자 했었고, 실제로 게임에 활용하였습니다!
